...
document.addEventListener("DOMContentLoaded", function () {
        ...
        img.onload = function() {
            ...
            if (swatches) {
                ...
                if (swatches.Vibrant) {
                    ...
                    root.style.setProperty('--primary-dark', adjustBrightness(vibrantColor, -20));
                    root.style.setProperty('--primary-light', adjustBrightness(vibrantColor, 30));
                }
    ...
    window.shareProduct = function (platform) {
        ...
        const description = encodeURIComponent(document.querySelector('meta[property="og:description"]')?.content || '');
    ...
    function animateOnScroll() {
        const elements = document.querySelectorAll('.feature-card, .video-card, .product-info');
    ...
    document.querySelectorAll('.feature-card, .video-card, .product-info').forEach(element => {
